function out = WH_wTGV(params)
% Linear Weak Harmonics - QSM and Total Generalized Variation regularization 
...
N = size(params.input);
    ...
    % Redifinition for computational efficiency
    FWy = fftn(weight.*FWy./(weight+mu2));
