...
params.TE           = headerAndExtraData.te*1e3; % TE in ms
...
chi = QSM_iLSQR(double(localField),double(mask), 'H',params.H,'voxelsize',voxelSize,...
    'padsize',params.padsize,'niter',params.niter,'TE',params.TE,'B0',params.B0);
