function [x, f1, obj_vals] = fnlCg_sc(params)
...
if params.LPWeight     %calc laplacian of acquired fmap - apply 3D laplacian
    ...
    LpFMAP(2:end-1, 2:end-1, 2:end-1) = -6 * fmap_acq(2:end-1, 2:end-1, 2:end-1) + fmap_acq(1:end-2, 2:end-1, 2:end-1) + fmap_acq(3:end, 2:end-1, 2:end-1) ...
...
if params.LPWeight
    ...
    LpFTx(2:end-1, 2:end-1, 2:end-1) = -6 * fmap_est(2:end-1,2:end-1, 2:end-1) + fmap_est(1:end-2,2:end-1, 2:end-1) + fmap_est(3:end,2:end-1, 2:end-1) ...
                                        + fmap_est(2:end-1,1:end-2, 2:end-1)+ fmap_est(2:end-1,2:end-1, 1:end-2) + fmap_est(2:end-1,2:end-1, 3:end);
    LpFTdx(2:end-1, 2:end-1, 2:end-1) =  -6 * fmap_est_dx(2:end-1,2:end-1, 2:end-1) + fmap_est_dx(1:end-2,2:end-1, 2:end-1) + fmap_est_dx(3:end,2:end-1, 2:end-1) ...
...
LP_k = 0 * w;
LP_k(2:end-1, 2:end-1, 2:end-1) = -6 * k(2:end-1,2:end-1, 2:end-1) + k(1:end-2,2:end-1, 2:end-1) + k(3:end,2:end-1, 2:end-1) + k(2:end-1,1:end-2, 2:end-1) + k(2:end-1,3:end, 2:end-1) + k(2:end-1,2:end-1, 1:end-2) + k(2:end-1, 2:end-1, 3:end);
