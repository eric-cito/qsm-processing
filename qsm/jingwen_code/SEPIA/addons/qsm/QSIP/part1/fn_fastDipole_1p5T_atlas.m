%%
function [nfm_final, nfm_dipole, atlas, msk, x] = fn_fastDipole_1p5T_atlas(subjnum_sph)
%
...
msk = load_nii('mask_BET_2020_2768.img');        
msk = imrotate(double(msk.img),90);

% mask_BET_2020_2768 must be changed from neurological to radiological
% orientation. 
for t = 1:size(msk,3)
     msk(:,:,t) = fliplr(msk(:,:,t));
end
...
nfm_final = nfm_final(257-128:256+128, 257-128:256+128, 63-31:62+31);
