function [param chi1_est chi_est chi_est_ppm fmap_est f1 obj_vals noise_thr fmap_lp mask1 mask2 mask3 nfm_final fmap_acq_corr, scales] = KOP_intsources_nfm_corr3_7T_HD_June2014(subjnum_sph, subjnum_rois, ext_src_dir, dims) 
%
%
%
%
...
%filename = strcat(ext_src_dir,'/FM_msk');  
%filename = 'FMR_mag_cmb_brain_mask2_ero';
%filename = 'FMR_mag_cmb_brain_mask2_ero';
%filename = 'ROR_mask_cmb';
%filename = 'ROR_mag_cmb_brain_bet_mask';

%filename = 'ROR_phase_bet_mask';
%filename = 'ROR_phase_bet_mask_ero_sph3';
filename = 'ROR_phase_bet_mask_ero_sph3_man';
